    ...
    <div className="mt-6 bg-white p-3 rounded-lg shadow-sm">
      <div className="grid grid-cols-3 gap-4 mb-3">
        <div className="text-center">
          <p className="text-sm text-gray-500 mb-2">Sunrise</p>
          <p className="font-semibold">{weather.sunrise}</p>
        </div>
        
        <div className="text-center border-x border-gray-100">
          <p className="text-sm text-gray-500 mb-2">Day Duration</p>
          <p className="font-semibold">{weather.dayDuration}</p>
        </div>
        
        <div className="text-center">
          <p className="text-sm text-gray-500 mb-2">Sunset</p>
      ...
      <div className="grid grid-cols-2 gap-4 pt-2 border-t border-gray-100">
        <div className="text-center">
          <p className="text-sm text-gray-500 mb-2">UV Dose</p>
          <p className="font-semibold">{uvDose.toFixed(1)}&nbsp;J/m²</p>
        </div>
        
        <div className="text-center">
          <p className="text-sm text-gray-500 mb-2">Daily Light Integral</p>
